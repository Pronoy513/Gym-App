...
class _ExerciseTrackerState extends State<ExerciseTracker> {
  List<ExerciseData> selectedExercises = [];
  ...
  void _selectExercise(String exerciseName) {
    setState(() {
      selectedExercises.add(ExerciseData(exerciseName, sets: '', reps: ''));
    });
  }
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ExerciseTile(selectedExercises[index]);
                    },
                  ),
                ),
              ],
...
class ExerciseData {
  ...
  ExerciseData(this.name, {this.sets = '', this.reps = ''});
}
